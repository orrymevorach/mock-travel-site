        ...
        return (
            <div className="nav-container">
                ...
                <LoginModal
                    ...
                    cheatPass={this.props.cheatPass}
                    handleChange={this.props.handleChange}
                    createUserFirstName={this.props.createUserFirstName}
                    createUserLastName={this.props.createUserLastName}
                    createUserEmail={this.props.createUserEmail}
                    createUserPassword={this.props.createUserPassword}
                    ...
                    <div className="wrapper clearfix text">
                        ...
                        <ul>
                            ...
                            {this.props.userLoggedIn === true ?
                                <li><NavLink to="/myTrips" activeClassName="active" onClick={() => window.scrollTo(0, 0)}>My Trips</NavLink></li>
                                : null}
